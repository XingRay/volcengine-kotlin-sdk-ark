...
@Serializable
@SerialName(ResponsesConstants.EVENT_TYPE_RESPONSE_CREATED)
data class ResponseCreatedEvent(
    @SerialName("type")
    override val type: String = ResponsesConstants.EVENT_TYPE_RESPONSE_CREATED,
    ...
    constructor() : this(ResponsesConstants.EVENT_TYPE_RESPONSE_CREATED)
}