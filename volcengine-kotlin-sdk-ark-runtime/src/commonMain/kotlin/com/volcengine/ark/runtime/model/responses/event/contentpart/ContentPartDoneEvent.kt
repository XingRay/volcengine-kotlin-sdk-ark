...
@Serializable
@SerialName(ResponsesConstants.EVENT_TYPE_RESPONSE_CONTENT_PART_DONE)
data class ContentPartDoneEvent(
    @SerialName("type")
    override val type: String = ResponsesConstants.EVENT_TYPE_RESPONSE_CONTENT_PART_DONE,
    ...
    constructor() : this(ResponsesConstants.EVENT_TYPE_RESPONSE_CONTENT_PART_DONE)
}