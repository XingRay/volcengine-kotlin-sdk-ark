...
@Serializable
@SerialName(ResponsesConstants.EVENT_TYPE_RESPONSE_FAILED)
data class ResponseFailedEvent(
    @SerialName("type")
    override val type: String = ResponsesConstants.EVENT_TYPE_RESPONSE_FAILED,
    ...
    constructor() : this(ResponsesConstants.EVENT_TYPE_RESPONSE_FAILED)
}